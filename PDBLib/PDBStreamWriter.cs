...
namespace PDBLib
{
    public class PDBStreamWriter
    {
        ...
        {
            this.WriteBytes(BitConverter.GetBytes(data));
            return sizeof(int);
        }
        public int Write(uint data)
        {
            this.WriteBytes(BitConverter.GetBytes(data));
            return sizeof(uint);
        }
        ...
        public void Reserve<T>() where T : struct
        {
            this.Reserve(Marshal.SizeOf<T>());
        }
